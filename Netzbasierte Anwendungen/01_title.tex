...
\textsc{\large Projektdokumentation}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \LARGE \bfseries Cache und Push-Notifications in mobilen Webanwendungen}\\ % Title of your document
